...
def docker_api_create(req_model, req_pipeline_tag, req_port_model, req_port_vllm):
    try:
        ...
        new_entry = [{
            "gpu": 0,
            "path": f'/root/models/{req_container_name}',
            "container": "0",
            "container_status": "0",
...
with gr.Blocks() as app:
    ...
    action_textbox = gr.Textbox(value="update", visible=True)
    btn_update.click(docker_api, inputs=[action_textbox,model_dropdown], outputs=create_response)
